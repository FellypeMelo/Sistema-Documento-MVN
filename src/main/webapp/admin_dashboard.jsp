<%@ page
    ...
    <body class="font-display bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark">
        <% // Retrieve data from request attributes 
            List<Solicitation> solicitations = (List<Solicitation>)request.getAttribute("solicitations");
            List<User> allUsers = (List<User>) request.getAttribute("allUsers");
            List<DocumentType> allDocumentTypes = (List<DocumentType>) request.getAttribute("allDocumentTypes");
                                                                ...
                                                                <header
                                                                    ...
                                                                    <div>
                                                                        <h1
                                                                            ...
                                                                            Solicitacoes</h1>
                                                                        <p class="text-sm text-neutral">Gerencie
                                                                            as solicitacoes
                                                                            de documentos</p>
                                                                    </div>
                                                                                ...
                                                                                <table class="w-full">
                                                                                    ...
                                                                                    <tbody
                                                                                        ...
                                                                                        <% for (Solicitation
                                                                                            ...
                                                                                            statusIcon="" ; String
                                                                                            priorityColorClass="" ;
                                                                                            String urgencyColorClass=""
                                                                                            ; // Status styling switch
                                                                                            ...
                                                                                            ; statusIcon="help" ; }
                                                                                            // Priority styling if
                                                                                            if ("Alta".equals(solicitation.getPrioridade()))
                                                                                            {
                                                                                            ...
                                                                                            ; }
                                                                                            // Urgency styling if
                                                                                            if ("Alta".equals(solicitation.getUrgencia()))
                                                                                            {
